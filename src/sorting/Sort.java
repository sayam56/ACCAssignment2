...
public final class Sort
{
    ...
    public static long randomKeyGenerator(Random r){
    	long lowerLimit = 1;
    	long upperLimit = 100000;
        
        long number = lowerLimit+((long)(r.nextLong()*(upperLimit-lowerLimit)));
        return number;
      }
	...
	//      merge sort
	      for(int i=0; i< repeat;i++) {
	      	Long [ ] keys = new Long[ NUM_ITEMS ];
	      	
	          for( int j = 0; j < keys.length; j++ )
	          	keys[j] = randomKeyGenerator(rand);
